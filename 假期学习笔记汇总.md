...
2. Java来自于[sun](https://baike.baidu.com/item/Sun%20Microsystems/6064586?fromtitle=sun%E5%85%AC%E5%8F%B8&fromid=970256&fr=aladdin)(被Oracle公司收购)。
...
| 1999      | Java分为3个大块：j2se(标准版)、j2ee(企业版)、j2me(微型版) |
| 2004      | 更名jdk5.0(里程碑版本)                                    |
| 2005      | 10周年，更名javaSe、 javaEE、 javaME                      |
| 2014      | Jdk8.0 （维护时间2030-12）                                |
...
- JDK 14：instanceof 模式识别、Records、弃用 Parallel Scavenge + Serial GC 组合、删除 CMSGC

### 1.2.1 JavaSE、JavaEE、JavaME三者之间关系

<img src=".\img\JavaSE、JavaEE、JavaME关系.png" alt="JavaSE、JavaEE、JavaME关系" style="zoom: 25%;" />
...
<img src=".\img\多个类生成多个字节码文件演示.png" alt="多个类生成多个字节码文件演示" style="zoom:67%;" />
